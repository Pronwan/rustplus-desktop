namespace RustPlusDesk.Properties {
    ...
    public class Resources {
        ...
        public static string GlobalChatTitle => GetString("GlobalChatTitle");
        public static string GlobalChatTickerOnline => GetString("GlobalChatTickerOnline");
        public static string GlobalChatTickerQuiet => GetString("GlobalChatTickerQuiet");
        public static string GlobalChatTickerIdle => GetString("GlobalChatTickerIdle");
        public static string GlobalChatTickerHide => GetString("GlobalChatTickerHide");
        public static string GlobalChatTickerSetting => GetString("GlobalChatTickerSetting");
        public static string GlobalChatTickerSettingHint => GetString("GlobalChatTickerSettingHint");
        public static string GlobalChatPlaceholder => GetString("GlobalChatPlaceholder");
        public static string GlobalChatSignInNotice => GetString("GlobalChatSignInNotice");
        public static string GlobalChatConsentNotice => GetString("GlobalChatConsentNotice");
        public static string ChatTranslate => GetString("ChatTranslate");
        public static string ChatReport => GetString("ChatReport");
        public static string ChatBlock => GetString("ChatBlock");
        public static string ChatReportSent => GetString("ChatReportSent");
        public static string ChatReportFailed => GetString("ChatReportFailed");
        public static string ChatBlockDone => GetString("ChatBlockDone");
        public static string ChatBlockFailed => GetString("ChatBlockFailed");
        public static string ChatSlowModeActive => GetString("ChatSlowModeActive");
        public static string GlobalChatMentionToastTitle => GetString("GlobalChatMentionToastTitle");
        public static string ChatRefusedSanctioned => GetString("ChatRefusedSanctioned");
        ...
        public static string CommandDockGrowth => GetString("CommandDockGrowth");
        ...
        public static string AiCompanionAnswerLanguage => GetString("AiCompanionAnswerLanguage");
        public static string AiCompanionLanguageMatch => GetString("AiCompanionLanguageMatch");
        public static string AiCompanionLanguageApp => GetString("AiCompanionLanguageApp");
        public static string AiCompanionLanguageEnglish => GetString("AiCompanionLanguageEnglish");
        public static string AiCompanionLanguageMatchNote => GetString("AiCompanionLanguageMatchNote");
